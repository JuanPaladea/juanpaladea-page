      ...
      <div className="container mx-auto flex px-5 py-12 md:flex-row flex-col items-center">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          ...
          <p className="mb-8 leading-relaxed">
            I am a software developer focused on backend development. I have experience in building RESTful APIs and services using Node.js and Express.js. I am also familiar with databases like MongoDB and MySQL. I am looking for opportunities to work on exciting projects and learn new technologies.
          </p>
          <div className="flex justify-center">
            ...
            <a href="https://drive.google.com/file/d/1b_S2-fbZt_qIW90RjseIYeyqvYDLBZ5_/view?usp=sharing" target="_blank" title="CV">
