              ...
              <div className="h-full border-2 border-gray-800 rounded-lg overflow-hidden">
                <div className="relative group">
                  <img
                    ...
                    alt="Libelulis e-commerce"
                    title="Libelulis e-commerce"
                  />
                  <a href="https://libelulis.vercel.app/" target="_blank" title="Libelulis live link" className="absolute inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <div className="h-full flex items-center p-4 rounded-lg hover:cursor-pointer">
                      <img
                        alt="JavaScript icon"
                        title="JavaScript icon"
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center flex-wrap ">
                    <a href="https://libelulis.vercel.app/" target="_blank" title="Libelulis live link" className="text-indigo-400 inline-flex items-center md:mb-2 lg:mb-0">
                      Live demo
                    </a>
                    <span className="text-gray-500 mr-3 inline-flex items-center lg:ml-auto md:ml-0 ml-auto leading-none text-sm pr-3 py-1">
                      <a href="https://github.com/JuanPaladea/Libelulis" target="_blank" title="Libelulis github link" className="text-indigo-400 inline-flex items-center md:mb-2 lg:mb-0">
                        Github
                      </a>
                    </span>
                  </div>
