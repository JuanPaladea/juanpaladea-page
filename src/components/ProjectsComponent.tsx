            ...
            <div className="p-4 md:w-1/2 lg:w-1/3 mx-auto">
              <div className="h-full border-2 border-gray-800 rounded-lg overflow-hidden">
                <div className="relative group">
                  <img
                    className="lg:h-48 md:h-36 w-full object-cover object-center transition-transform duration-500 transform group-hover:rotate-y-180"
                    src="https://i.imgur.com/X78qbnt.png"
                    alt="Movie System Page"
                    title="Movie System Page"
                  />
                  <a href="https://movie-reservation-front.vercel.app/" target="blank" title="Movie System Live Link" className="absolute inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <div className="h-full flex items-center p-4 rounded-lg hover:cursor-pointer">
                      <img
                        alt="TypeScript icon"
                ...
                <div className="p-6">
                  ...
                  <p className="leading-relaxed mb-3">
                    Frontend application that uses TypeScript and Vite. The application provides a platform for managing movies, seats, showtimes and reservations. It also includes user authentication and authorization. Consumes the backend API.
                  </p>
                  <div className="flex items-center flex-wrap ">
                    <a href="https://movie-reservation-front.vercel.app/" target="_blank" title="MovieFront Live Link" className="text-indigo-400 inline-flex items-center md:mb-2 lg:mb-0">
                      Live demo
                    </a>
                    <span className="text-gray-500 mr-3 inline-flex items-center lg:ml-auto md:ml-0 ml-auto leading-none text-sm pr-3 py-1">
                      <a href="https://github.com/JuanPaladea/MovieReservationFront" target="_blank" title="MovieFront Github Link" className="text-indigo-400 inline-flex items-center md:mb-2 lg:mb-0">
                        Github
                      </a>
                    </span>
                  </div>
